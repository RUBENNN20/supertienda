...
class HogarmakroScreen extends StatefulWidget {
  const HogarmakroScreen({super.key});

  @override
  _HogarmakroScreenState createState() => _HogarmakroScreenState();
}

class _HogarmakroScreenState extends State<HogarmakroScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Hogar Makro"; // Store name can be dynamic if needed
