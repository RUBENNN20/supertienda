...
class TecnologiamakroScreen extends StatefulWidget {
  const TecnologiamakroScreen({super.key});

  @override
  _TecnologiamakroScreenState createState() => _TecnologiamakroScreenState();
}

class _TecnologiamakroScreenState extends State<TecnologiamakroScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Tecnologia Makro"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tecnologia MAKRO'),
