...
class DeportesexitoScreen extends StatefulWidget {
  const DeportesexitoScreen({super.key});

  @override
  _DeportesexitoScreenState createState() => _DeportesexitoScreenState();
}

class _DeportesexitoScreenState extends State<DeportesexitoScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Deportes Exito"; // Store name can be dynamic if needed
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Deportes EXITO'),
