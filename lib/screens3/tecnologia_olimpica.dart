...
class TecnologiaolimpicaScreen extends StatefulWidget {
  const TecnologiaolimpicaScreen({super.key});

  @override
  _TecnologiaolimpicaScreenState createState() => _TecnologiaolimpicaScreenState();
}

class _TecnologiaolimpicaScreenState extends State<TecnologiaolimpicaScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Tecnologia Olimpica"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tecnologia OLIMPICA'),
