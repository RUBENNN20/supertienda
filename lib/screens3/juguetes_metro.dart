...
class JuguetesmetroScreen extends StatefulWidget {
  const JuguetesmetroScreen({super.key});

  @override
  _JuguetesmetroScreenState createState() => _JuguetesmetroScreenState();
}

class _JuguetesmetroScreenState extends State<JuguetesmetroScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Juguetes Metro"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Juguetes METRO'),
