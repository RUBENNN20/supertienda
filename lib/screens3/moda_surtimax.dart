...
class ModasurtimaxScreen extends StatefulWidget {
  const ModasurtimaxScreen({super.key});

  @override
  _ModasurtimaxScreenState createState() => _ModasurtimaxScreenState();
}

class _ModasurtimaxScreenState extends State<ModasurtimaxScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Moda Surtimax"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Moda SURTIMAX'),
