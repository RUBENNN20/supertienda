...
class HogarcarullaScreen extends StatefulWidget {
  const HogarcarullaScreen({super.key});

  @override
  _HogarcarullaScreenState createState() => _HogarcarullaScreenState();
}

class _HogarcarullaScreenState extends State<HogarcarullaScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Hogar Carulla"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Hogar CARULLA'),
