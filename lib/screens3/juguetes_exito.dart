...
class JuguetesexitoScreen extends StatefulWidget {
  const JuguetesexitoScreen({super.key});

  @override
  _JuguetesexitoScreenState createState() => _JuguetesexitoScreenState();
}

class _JuguetesexitoScreenState extends State<JuguetesexitoScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Juguetes Exito"; // Store name can be dynamic if needed
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Juguetes EXITO'),
