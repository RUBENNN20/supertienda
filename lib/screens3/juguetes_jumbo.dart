...
class JuguetesjumboScreen extends StatefulWidget {
  const JuguetesjumboScreen({super.key});

  @override
  _JuguetesjumboScreenState createState() => _JuguetesjumboScreenState();
}

class _JuguetesjumboScreenState extends State<JuguetesjumboScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Juguetes Jumbo"; // Store name can be dynamic if needed
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Juguetes JUMBO'),
