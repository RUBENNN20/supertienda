...
class JuguetessurtimaxScreen extends StatefulWidget {
  const JuguetessurtimaxScreen({super.key});

  @override
  _JuguetessurtimaxScreenState createState() => _JuguetessurtimaxScreenState();
}

class _JuguetessurtimaxScreenState extends State<JuguetessurtimaxScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Juguetes Surtimax"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Juguetes SURTIMAX'),
