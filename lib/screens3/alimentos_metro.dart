...
import 'package:mi_super_tienda/screens2/supermercado9_screen.dart';
import 'package:provider/provider.dart';
import 'package:shared_preferences/shared_preferences.dart';
import '../models/product.dart';
import '../providers/cart_provider.dart';

class AlimentosmetroScreen extends StatefulWidget {
  const AlimentosmetroScreen({super.key});

  @override
  _AlimentosmetroScreenState createState() => _AlimentosmetroScreenState();
}

class _AlimentosmetroScreenState extends State<AlimentosmetroScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Alimentos Metro"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Alimentos METRO'),
