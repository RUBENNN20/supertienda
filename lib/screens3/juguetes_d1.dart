...
class Juguetesd1Screen extends StatefulWidget {
  const Juguetesd1Screen({super.key});

  @override
  _Juguetesd1ScreenState createState() => _Juguetesd1ScreenState();
}

class _Juguetesd1ScreenState extends State<Juguetesd1Screen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Juguetes D1"; // Store name can be dynamic if needed
