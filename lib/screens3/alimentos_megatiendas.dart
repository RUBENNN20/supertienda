...
class AlimentosmegatiendasScreen extends StatefulWidget {
  const AlimentosmegatiendasScreen({super.key});

  @override
  _AlimentosmegatiendasScreenState createState() => _AlimentosmegatiendasScreenState();
}

class _AlimentosmegatiendasScreenState extends State<AlimentosmegatiendasScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Alimentos Megatiendas"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Alimentos MEGATIENDAS'),
