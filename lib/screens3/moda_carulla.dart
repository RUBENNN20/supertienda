...
class ModacarullaScreen extends StatefulWidget {
  const ModacarullaScreen({super.key});

  @override
  _ModacarullaScreenState createState() => _ModacarullaScreenState();
}

class _ModacarullaScreenState extends State<ModacarullaScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Moda Carulla"; // Store name can be dynamic if needed
