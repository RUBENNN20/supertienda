...
class ModametroScreen extends StatefulWidget {
  const ModametroScreen({super.key});

  @override
  _ModametroScreenState createState() => _ModametroScreenState();
}

class _ModametroScreenState extends State<ModametroScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Moda Metro"; // Store name can be dynamic if needed
