...
class Hogard1Screen extends StatefulWidget {
  const Hogard1Screen({super.key});

  @override
  _Hogard1ScreenState createState() => _Hogard1ScreenState();
}

class _Hogard1ScreenState extends State<Hogard1Screen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Hogar D1"; // Store name can be dynamic if needed
