...
class TecnologiajumboScreen extends StatefulWidget {
  const TecnologiajumboScreen({super.key});

  @override
  _TecnologiajumboScreenState createState() => _TecnologiajumboScreenState();
}

class _TecnologiajumboScreenState extends State<TecnologiajumboScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Tecnologia Jumbo"; // Store name can be dynamic if needed
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tecnologia JUMBO'),
