...
class Deportesd1Screen extends StatefulWidget {
  const Deportesd1Screen({super.key});

  @override
  _Deportesd1ScreenState createState() => _Deportesd1ScreenState();
}

class _Deportesd1ScreenState extends State<Deportesd1Screen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Deportes D1"; // Store name can be dynamic if needed
