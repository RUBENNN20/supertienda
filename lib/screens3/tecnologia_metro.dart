...
class TecnologiametroScreen extends StatefulWidget {
  const TecnologiametroScreen({super.key});

  @override
  _TecnologiametroScreenState createState() => _TecnologiametroScreenState();
}

class _TecnologiametroScreenState extends State<TecnologiametroScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Tecnologia Metro"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tecnologia METRO'),
