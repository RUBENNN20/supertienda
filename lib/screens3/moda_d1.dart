...
class Modad1Screen extends StatefulWidget {
  const Modad1Screen({super.key});

  @override
  _Modad1ScreenState createState() => _Modad1ScreenState();
}

class _Modad1ScreenState extends State<Modad1Screen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Moda D1"; // Store name can be dynamic if needed
