...
class DeportesmegatiendasScreen extends StatefulWidget {
  const DeportesmegatiendasScreen({super.key});

  @override
  _DeportesmegatiendasScreenState createState() => _DeportesmegatiendasScreenState();
}

class _DeportesmegatiendasScreenState extends State<DeportesmegatiendasScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Deportes Megatiendas"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Deportes MEGATIENDAS'),
