...
import 'package:mi_super_tienda/screens2/supermercado2_screen.dart';
import 'package:provider/provider.dart';
import 'package:shared_preferences/shared_preferences.dart';
import '../models/product.dart';
import '../providers/cart_provider.dart';

class AlimentosjumboScreen extends StatefulWidget {
  const AlimentosjumboScreen({super.key});

  @override
  _AlimentosjumboScreenState createState() => _AlimentosjumboScreenState();
}

class _AlimentosjumboScreenState extends State<AlimentosjumboScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Alimentos Jumbo"; // Store name can be dynamic if needed
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Alimentos JUMBO'),
