...
class HogararaScreen extends StatefulWidget {
  const HogararaScreen({super.key});

  @override
  _HogararaScreenState createState() => _HogararaScreenState();
}

class _HogararaScreenState extends State<HogararaScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Hogar Ara"; // Store name can be dynamic if needed
