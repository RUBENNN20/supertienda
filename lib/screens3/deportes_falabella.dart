...
class DeportesfalabellaScreen extends StatefulWidget {
  const DeportesfalabellaScreen({super.key});

  @override
  _DeportesfalabellaScreenState createState() => _DeportesfalabellaScreenState();
}

class _DeportesfalabellaScreenState extends State<DeportesfalabellaScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Deportes Falabella"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Deportes FALABELLA'),
