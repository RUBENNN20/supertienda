...
class JuguetesaraScreen extends StatefulWidget {
  const JuguetesaraScreen({super.key});

  @override
  _JuguetesaraScreenState createState() => _JuguetesaraScreenState();
}

class _JuguetesaraScreenState extends State<JuguetesaraScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Juguetes Ara"; // Store name can be dynamic if needed
