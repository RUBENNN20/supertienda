...
class ModaolimpicaScreen extends StatefulWidget {
  const ModaolimpicaScreen({super.key});

  @override
  _ModaolimpicaScreenState createState() => _ModaolimpicaScreenState();
}

class _ModaolimpicaScreenState extends State<ModaolimpicaScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Moda Olimpica"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Moda OLIMPICA'),
