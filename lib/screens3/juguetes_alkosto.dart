...
class JuguetesalkostoScreen extends StatefulWidget {
  const JuguetesalkostoScreen({super.key});

  @override
  _JuguetesalkostoScreenState createState() => _JuguetesalkostoScreenState();
}

class _JuguetesalkostoScreenState extends State<JuguetesalkostoScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Juguetes Alkosto"; // Store name can be dynamic if needed
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Juguetes ALKOSTO'),
