...
class ModajumboScreen extends StatefulWidget {
  const ModajumboScreen({super.key});

  @override
  _ModajumboScreenState createState() => _ModajumboScreenState();
}

class _ModajumboScreenState extends State<ModajumboScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Moda Jumbo"; // Store name can be dynamic if needed
