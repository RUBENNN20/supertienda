...
class DeportescarullaScreen extends StatefulWidget {
  const DeportescarullaScreen({super.key});

  @override
  _DeportescarullaScreenState createState() => _DeportescarullaScreenState();
}

class _DeportescarullaScreenState extends State<DeportescarullaScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Deportes Carulla"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Deportes CARULLA'),
