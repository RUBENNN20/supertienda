...
class ModamakroScreen extends StatefulWidget {
  const ModamakroScreen({super.key});

  @override
  _ModamakroScreenState createState() => _ModamakroScreenState();
}

class _ModamakroScreenState extends State<ModamakroScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Moda Makro"; // Store name can be dynamic if needed
