...
class HogarexitoScreen extends StatefulWidget {
  const HogarexitoScreen({super.key});

  @override
  _HogarexitoScreenState createState() => _HogarexitoScreenState();
}

class _HogarexitoScreenState extends State<HogarexitoScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Hogar Exito"; // Store name can be dynamic if needed
