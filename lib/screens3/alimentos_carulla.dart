...
import 'package:mi_super_tienda/screens2/supermercado3_screen.dart';
import 'package:provider/provider.dart';
import 'package:shared_preferences/shared_preferences.dart';
import '../models/product.dart';
import '../providers/cart_provider.dart';

class AlimentoscarullaScreen extends StatefulWidget {
  const AlimentoscarullaScreen({super.key});

  @override
  _AlimentoscarullaScreenState createState() => _AlimentoscarullaScreenState();
}

class _AlimentoscarullaScreenState extends State<AlimentoscarullaScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Alimentos Carulla"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Alimentos CARULLA'),
