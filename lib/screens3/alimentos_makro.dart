...
import 'package:mi_super_tienda/screens2/supermercado10_screen.dart';
import 'package:provider/provider.dart';
import 'package:shared_preferences/shared_preferences.dart';
import '../models/product.dart';
import '../providers/cart_provider.dart';

class AlimentosmakroScreen extends StatefulWidget {
  const AlimentosmakroScreen({super.key});

  @override
  _AlimentosmakroScreenState createState() => _AlimentosmakroScreenState();
}

class _AlimentosmakroScreenState extends State<AlimentosmakroScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Alimentos Makro"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Alimentos MAKRO'),
