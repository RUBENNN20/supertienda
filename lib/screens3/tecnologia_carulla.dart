...
class TecnologiacarullaScreen extends StatefulWidget {
  const TecnologiacarullaScreen({super.key});

  @override
  _TecnologiacarullaScreenState createState() => _TecnologiacarullaScreenState();
}

class _TecnologiacarullaScreenState extends State<TecnologiacarullaScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Tecnologia Carulla"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tecnologia CARULLA'),
