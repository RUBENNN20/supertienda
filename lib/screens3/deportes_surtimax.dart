...
class DeportessurtimaxScreen extends StatefulWidget {
  const DeportessurtimaxScreen({super.key});

  @override
  _DeportessurtimaxScreenState createState() => _DeportessurtimaxScreenState();
}

class _DeportessurtimaxScreenState extends State<DeportessurtimaxScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Deportes Surtimax"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Deportes SURTIMAX'),
