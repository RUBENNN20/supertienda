...
class ModamegatiendasScreen extends StatefulWidget {
  const ModamegatiendasScreen({super.key});

  @override
  _ModamegatiendasScreenState createState() => _ModamegatiendasScreenState();
}

class _ModamegatiendasScreenState extends State<ModamegatiendasScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Moda Megatiendas"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Moda MEGATIENDAS'),
