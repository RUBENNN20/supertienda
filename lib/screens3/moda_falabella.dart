...
class ModafalabellaScreen extends StatefulWidget {
  const ModafalabellaScreen({super.key});

  @override
  _ModafalabellaScreenState createState() => _ModafalabellaScreenState();
}

class _ModafalabellaScreenState extends State<ModafalabellaScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Moda Falabella"; // Store name can be dynamic if needed
  String categoryName = "Moda"; // Category name can also be dynamic
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Moda FALABELLA'),
