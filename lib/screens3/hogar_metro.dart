...
class HogarmetroScreen extends StatefulWidget {
  const HogarmetroScreen({super.key});

  @override
  _HogarmetroScreenState createState() => _HogarmetroScreenState();
}

class _HogarmetroScreenState extends State<HogarmetroScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Hogar Metro"; // Store name can be dynamic if needed
