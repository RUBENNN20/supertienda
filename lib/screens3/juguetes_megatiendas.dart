...
class JuguetesmegatiendasScreen extends StatefulWidget {
  const JuguetesmegatiendasScreen({super.key});

  @override
  _JuguetesmegatiendasScreenState createState() => _JuguetesmegatiendasScreenState();
}

class _JuguetesmegatiendasScreenState extends State<JuguetesmegatiendasScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Juguetes Megatiendas"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Juguetes MEGATIENDAS'),
