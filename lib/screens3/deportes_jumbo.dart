...
class DeportesjumboScreen extends StatefulWidget {
  const DeportesjumboScreen({super.key});

  @override
  _DeportesjumboScreenState createState() => _DeportesjumboScreenState();
}

class _DeportesjumboScreenState extends State<DeportesjumboScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Deportes Jumbo"; // Store name can be dynamic if needed
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Deportes JUMBO'),
