...
import 'package:mi_super_tienda/screens2/supermercado12_screen.dart';
import 'package:provider/provider.dart';
import 'package:shared_preferences/shared_preferences.dart';
import '../models/product.dart';
import '../providers/cart_provider.dart';

class AlimentosfalabellaScreen extends StatefulWidget {
  const AlimentosfalabellaScreen({super.key});

  @override
  _AlimentosfalabellaScreenState createState() => _AlimentosfalabellaScreenState();
}

class _AlimentosfalabellaScreenState extends State<AlimentosfalabellaScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Alimentos Falabella"; // Store name can be dynamic if needed
  String categoryName = "Alimentos"; // Category name can also be dynamic
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Alimentos FALABELLA'),
