...
class ModaaraScreen extends StatefulWidget {
  const ModaaraScreen({super.key});

  @override
  _ModaaraScreenState createState() => _ModaaraScreenState();
}

class _ModaaraScreenState extends State<ModaaraScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Moda Ara"; // Store name can be dynamic if needed
