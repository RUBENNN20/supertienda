...
class HogarjumboScreen extends StatefulWidget {
  const HogarjumboScreen({super.key});

  @override
  _HogarjumboScreenState createState() => _HogarjumboScreenState();
}

class _HogarjumboScreenState extends State<HogarjumboScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Hogar Jumbo"; // Store name can be dynamic if needed
