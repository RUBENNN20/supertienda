...
class JuguetescarullaScreen extends StatefulWidget {
  const JuguetescarullaScreen({super.key});

  @override
  _JuguetescarullaScreenState createState() => _JuguetescarullaScreenState();
}

class _JuguetescarullaScreenState extends State<JuguetescarullaScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Juguetes Carulla"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Juguetes CARULLA'),
