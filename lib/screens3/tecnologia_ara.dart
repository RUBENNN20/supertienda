...
class TecnologiaaraScreen extends StatefulWidget {
  const TecnologiaaraScreen({super.key});

  @override
  _TecnologiaaraScreenState createState() => _TecnologiaaraScreenState();
}

class _TecnologiaaraScreenState extends State<TecnologiaaraScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Tecnologia Ara"; // Store name can be dynamic if needed
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tecnologia ARA'),
