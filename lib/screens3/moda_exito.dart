...
class ModaexitoScreen extends StatefulWidget {
  const ModaexitoScreen({super.key});

  @override
  _ModaexitoScreenState createState() => _ModaexitoScreenState();
}

class _ModaexitoScreenState extends State<ModaexitoScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Moda Exito"; // Store name can be dynamic if needed
