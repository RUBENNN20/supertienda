...
class Tecnologiad1Screen extends StatefulWidget {
  const Tecnologiad1Screen({super.key});

  @override
  _Tecnologiad1ScreenState createState() => _Tecnologiad1ScreenState();
}

class _Tecnologiad1ScreenState extends State<Tecnologiad1Screen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Tecnologia D1"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tecnologia D1'),
