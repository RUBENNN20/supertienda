...
import 'package:mi_super_tienda/screens2/supermercado11_screen.dart';
import 'package:provider/provider.dart';
import 'package:shared_preferences/shared_preferences.dart';
import '../models/product.dart';
import '../providers/cart_provider.dart';

class AlimentosolimpicaScreen extends StatefulWidget {
  const AlimentosolimpicaScreen({super.key});

  @override
  _AlimentosolimpicaScreenState createState() => _AlimentosolimpicaScreenState();
}

class _AlimentosolimpicaScreenState extends State<AlimentosolimpicaScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Alimentos Olimpica"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Alimentos OLIMPICA'),
