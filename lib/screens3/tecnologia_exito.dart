...
class TecnologiaexitoScreen extends StatefulWidget {
  const TecnologiaexitoScreen({super.key});

  @override
  _TecnologiaexitoScreenState createState() => _TecnologiaexitoScreenState();
}

class _TecnologiaexitoScreenState extends State<TecnologiaexitoScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Tecnologia Exito"; // Store name can be dynamic if needed
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tecnologia EXITO'),
