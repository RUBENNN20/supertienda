...
class HogarfalabellaScreen extends StatefulWidget {
  const HogarfalabellaScreen({super.key});

  @override
  _HogarfalabellaScreenState createState() => _HogarfalabellaScreenState();
}

class _HogarfalabellaScreenState extends State<HogarfalabellaScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Hogar Falabella"; // Store name can be dynamic if needed
  String categoryName = "Hogar"; // Category name can also be dynamic
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Hogar FALABELLA'),
