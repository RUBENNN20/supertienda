...
class DeportesmakroScreen extends StatefulWidget {
  const DeportesmakroScreen({super.key});

  @override
  _DeportesmakroScreenState createState() => _DeportesmakroScreenState();
}

class _DeportesmakroScreenState extends State<DeportesmakroScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Deportes Makro"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Deportes MAKRO'),
