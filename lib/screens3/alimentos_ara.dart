...
class AlimentosaraScreen extends StatefulWidget {
  const AlimentosaraScreen({super.key});

  @override
  _AlimentosaraScreenState createState() => _AlimentosaraScreenState();
}

class _AlimentosaraScreenState extends State<AlimentosaraScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Alimentos Ara"; // Store name can be dynamic if needed
