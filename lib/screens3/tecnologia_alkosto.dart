...
class TecnologiaalkostoScreen extends StatefulWidget {
  const TecnologiaalkostoScreen({super.key});

  @override
  _TecnologiaalkostoScreenState createState() => _TecnologiaalkostoScreenState();
}

class _TecnologiaalkostoScreenState extends State<TecnologiaalkostoScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Tecnologia Alkosto"; // Store name can be dynamic if needed
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tecnologia ALKOSTO'),
