...
class TecnologiafalabellaScreen extends StatefulWidget {
  const TecnologiafalabellaScreen({super.key});

  @override
  _TecnologiafalabellaScreenState createState() => _TecnologiafalabellaScreenState();
}

class _TecnologiafalabellaScreenState extends State<TecnologiafalabellaScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Tecnologia Falabella"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tecnologia FALABELLA'),
