...
class DeportesalkostoScreen extends StatefulWidget {
  const DeportesalkostoScreen({super.key});

  @override
  _DeportesalkostoScreenState createState() => _DeportesalkostoScreenState();
}

class _DeportesalkostoScreenState extends State<DeportesalkostoScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Deportes Alkosto"; // Store name can be dynamic if needed
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Deportes ALKOSTO'),
