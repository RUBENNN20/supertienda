...
import 'package:mi_super_tienda/screens2/supermercado4_screen.dart';
import 'package:provider/provider.dart';
import 'package:shared_preferences/shared_preferences.dart';
import '../models/product.dart';
import '../providers/cart_provider.dart';

class AlimentossurtimaxScreen extends StatefulWidget {
  const AlimentossurtimaxScreen({super.key});

  @override
  _AlimentossurtimaxScreenState createState() => _AlimentossurtimaxScreenState();
}

class _AlimentossurtimaxScreenState extends State<AlimentossurtimaxScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Alimentos Surtimax"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Alimentos SURTIMAX'),
