...
class HogaralkostoScreen extends StatefulWidget {
  const HogaralkostoScreen({super.key});

  @override
  _HogaralkostoScreenState createState() => _HogaralkostoScreenState();
}

class _HogaralkostoScreenState extends State<HogaralkostoScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Hogar Alkosto"; // Store name can be dynamic if needed
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Hogar ALKOSTO'),
