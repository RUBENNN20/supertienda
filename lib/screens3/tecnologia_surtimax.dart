...
class TecnologiasurtimaxScreen extends StatefulWidget {
  const TecnologiasurtimaxScreen({super.key});

  @override
  _TecnologiasurtimaxScreenState createState() => _TecnologiasurtimaxScreenState();
}

class _TecnologiasurtimaxScreenState extends State<TecnologiasurtimaxScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Tecnologia Surtimax"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tecnologia SURTIMAX'),
