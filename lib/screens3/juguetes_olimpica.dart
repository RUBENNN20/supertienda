...
class JuguetesolimpicaScreen extends StatefulWidget {
  const JuguetesolimpicaScreen({super.key});

  @override
  _JuguetesolimpicaScreenState createState() => _JuguetesolimpicaScreenState();
}

class _JuguetesolimpicaScreenState extends State<JuguetesolimpicaScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Juguetes Olimpica"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Juguetes OLIMPICA'),
