...
class HogarolimpicaScreen extends StatefulWidget {
  const HogarolimpicaScreen({super.key});

  @override
  _HogarolimpicaScreenState createState() => _HogarolimpicaScreenState();
}

class _HogarolimpicaScreenState extends State<HogarolimpicaScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Hogar Olimpica"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Hogar OLIMPICA'),
