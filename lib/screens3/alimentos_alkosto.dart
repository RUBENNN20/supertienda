...
import 'package:mi_super_tienda/screens2/supermercado7_screen.dart';
import 'package:provider/provider.dart';
import 'package:shared_preferences/shared_preferences.dart';
import '../models/product.dart';
import '../providers/cart_provider.dart';

class AlimentosalkostoScreen extends StatefulWidget {
  const AlimentosalkostoScreen({super.key});

  @override
  _AlimentosalkostoScreenState createState() => _AlimentosalkostoScreenState();
}

class _AlimentosalkostoScreenState extends State<AlimentosalkostoScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Alimentos Alkosto"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Alimentos ALKOSTO'),
