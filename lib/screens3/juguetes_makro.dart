...
class JuguetesmakroScreen extends StatefulWidget {
  const JuguetesmakroScreen({super.key});

  @override
  _JuguetesmakroScreenState createState() => _JuguetesmakroScreenState();
}

class _JuguetesmakroScreenState extends State<JuguetesmakroScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Juguetes Makro"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Juguetes MAKRO'),
