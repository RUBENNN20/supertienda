...
class DeportesolimpicaScreen extends StatefulWidget {
  const DeportesolimpicaScreen({super.key});

  @override
  _DeportesolimpicaScreenState createState() => _DeportesolimpicaScreenState();
}

class _DeportesolimpicaScreenState extends State<DeportesolimpicaScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Deportes Olimpica"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Deportes OLIMPICA'),
