...
class JuguetesfalabellaScreen extends StatefulWidget {
  const JuguetesfalabellaScreen({super.key});

  @override
  _JuguetesfalabellaScreenState createState() => _JuguetesfalabellaScreenState();
}

class _JuguetesfalabellaScreenState extends State<JuguetesfalabellaScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Juguetes Falabella"; // Store name can be dynamic if needed
  String categoryName = "Juguetes"; // Category name can also be dynamic
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Juguetes FALABELLA'),
