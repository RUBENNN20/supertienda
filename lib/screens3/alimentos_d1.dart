...
import 'package:mi_super_tienda/screens2/supermercado8_screen.dart';
import 'package:provider/provider.dart';
import 'package:shared_preferences/shared_preferences.dart';
import '../models/product.dart';
import '../providers/cart_provider.dart';

class Alimentosd1Screen extends StatefulWidget {
  const Alimentosd1Screen({super.key});

  @override
  _Alimentosd1ScreenState createState() => _Alimentosd1ScreenState();
}

class _Alimentosd1ScreenState extends State<Alimentosd1Screen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Alimentos D1"; // Store name can be dynamic if needed
