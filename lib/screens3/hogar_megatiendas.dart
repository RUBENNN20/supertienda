...
class HogarmegatiendasScreen extends StatefulWidget {
  const HogarmegatiendasScreen({super.key});

  @override
  _HogarmegatiendasScreenState createState() => _HogarmegatiendasScreenState();
}

class _HogarmegatiendasScreenState extends State<HogarmegatiendasScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Hogar Megatiendas"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Hogar MEGATIENDAS'),
