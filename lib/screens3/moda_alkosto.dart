...
class ModaalkostoScreen extends StatefulWidget {
  const ModaalkostoScreen({super.key});

  @override
  _ModaalkostoScreenState createState() => _ModaalkostoScreenState();
}

class _ModaalkostoScreenState extends State<ModaalkostoScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Moda Alkosto"; // Store name can be dynamic if needed
