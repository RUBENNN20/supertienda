...
class DeportesmetroScreen extends StatefulWidget {
  const DeportesmetroScreen({super.key});

  @override
  _DeportesmetroScreenState createState() => _DeportesmetroScreenState();
}

class _DeportesmetroScreenState extends State<DeportesmetroScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Deportes Metro"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Deportes METRO'),
