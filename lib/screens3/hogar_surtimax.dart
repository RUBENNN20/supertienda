...
class HogarsurtimaxScreen extends StatefulWidget {
  const HogarsurtimaxScreen({super.key});

  @override
  _HogarsurtimaxScreenState createState() => _HogarsurtimaxScreenState();
}

class _HogarsurtimaxScreenState extends State<HogarsurtimaxScreen> {
  List<Product> products = [];
  final ImagePicker _picker = ImagePicker();
  String storeName = "Hogar Surtimax"; // Store name can be dynamic if needed
...
void _addProduct(String title, String imageUrl, double price) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Hogar SURTIMAX'),
